...
CREATE TABLE purchase_item_list (
	id uuid NOT NULL,
	name varchar(127) NULL,
	brand varchar(127) NULL,
	default_price varchar(50) NULL,
	...
	updated_on timestamp NOT NULL DEFAULT now(),
	active bool NOT NULL DEFAULT true,
	CONSTRAINT purchase_item_list_pkey PRIMARY KEY (id)
);
...
alter table purchase_item add constraint purchase_item_fk_purchase_item_list_id foreign key (purchase_item_list_id) references purchase_item_list(id);