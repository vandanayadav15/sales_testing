...
describe('PurchaseItems Service', () => {
  ...
  describe(' - Entity Method Defined ', () => {
    it('should get purchaseItem details by id', async () => {
      jest
        .spyOn(purchaseItemRepo, 'findOne')
        .mockResolvedValueOnce(purchaseItmesData);
      expect(
        await purchaseItemService.entity(
          'b60edc15-7fd0-4df7-83e5-e0f061a7431b',
        ),
      ).toEqual(purchaseItmesData);
    });
  ...
  describe(' - Save Method', () => {
    it('save valid data', async () => {
      let data: any = {
        id: 'b60edc15-7fd0-4df7-83e5-e0f061a7431b',
  ...
  describe(' - Delete Method', () => {
    it('delete valid data', async () => {
      let reqData: any = {
        data: { id: 'b60edc15-7fd0-4df7-83e5-e0f061a7431b' },
      };
      let data: any = {
        id: 'b60edc15-7fd0-4df7-83e5-e0f061a7431b',
